...
class PdoGsb {
    ...
    public function getInfosVisiteur($login, $mdp) {
        $req = "select visiteur.id as id, visiteur.nom as nom, visiteur.prenom as prenom, 'Visiteur' as etat from visiteur 
		where visiteur.login='$login' and visiteur.mdp='$mdp' UNION select comptable.id as id, comptable.nom as nom, comptable.prenom as prenom, 'Comptable' as etat from comptable 
		where comptable.login='$login' and comptable.motDePasse='$mdp'";
